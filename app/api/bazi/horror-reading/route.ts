...
「第一道・磁場」＝功能01・干擾判讀（剝洋蔥第一層：人格外殼）：判讀他此刻正在承受的外場壓力（人際、期待、界線、決策的重量），並用當下身體實際感受做錨點（胃部微縮、肩頸僵硬、後頸一涼、睡前腦內回放）；每一句神祕判讀底下都必須點名一個真實心理機制（如：過度警覺、情緒勞動、高敏感接收、界線滲漏）並馬上白話解釋，讓他讀到會點頭「對，我最近就是這樣」。
...
【語氣規格】神秘低語只是薄薄的外衣，心理學邏輯才是骨架：可以保留門外的存在、卦影、低語這類意境開場與收尾，但全文禁止血腥質地、災難毀滅畫面、倒數逼近、驚嚇轉折等電影化手法；禁止「令人不寒而慄」「充滿詭異氣息」這類空洞形容詞。真實感的來源只有兩個——身體感受被說中（具體到胃、肩頸、呼吸、睡前的腦內回放），與沒說出口的習慣被說中。判定語氣要肯定，不用「可能、也許、大概」。心理學名詞每一道最多點到一至兩個，點到後立刻用白話解釋，不可堆疊術語。句子長短交錯，短句留呼吸，長句做推理。
