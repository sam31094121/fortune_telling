          ...
          <section ref={resultRef} tabIndex={-1} className="number-fortune-analysis-card scroll-mt-5 space-y-4 rounded-[26px] border border-amber-200/20 bg-[linear-gradient(145deg,rgba(12,15,22,0.98),rgba(28,23,14,0.95),rgba(8,10,16,0.98))] p-4 shadow-[0_22px_70px_rgba(0,0,0,0.34)] outline-none sm:p-5">
            ...
            {result.iching && (
              <details className="rounded-2xl border border-amber-200/30 bg-[linear-gradient(140deg,rgba(251,191,36,0.1),rgba(15,23,42,0.7))] p-4" aria-label="你的數字屬什麼卦">
                <summary className="flex min-h-[72px] cursor-pointer items-center justify-between gap-4 rounded-xl px-3 py-2 text-left transition hover:bg-amber-100/[0.08] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-amber-100 sm:min-h-[80px] sm:px-4">
                  <span className="numerology-hexagram-title text-2xl font-black leading-tight tracking-[0.12em] text-amber-50 sm:text-3xl">數字易經卦象</span>
