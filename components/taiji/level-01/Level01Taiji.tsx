  ...
  return (
    ...
    >
      ...
      {motionGameActive && (
        ...
        >
          <span key={`photon-north-${pose.motionGame.chase.direction}-${pose.motionGame.chase.hitId}`} className={`${styles.chaseLight} ${styles.chasePhotonNorth}`} aria-hidden="true" />
