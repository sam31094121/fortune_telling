...
const ERA_MANDARIN_SONGS: Record<string, MandarinTrack[]> = {
  ...
  '1990s': [
    ...
    { title: '夜夜夜夜',     artist: '齊秦',   videoId: 'd7GfC4HAt54', soulTags: ['搖滾','青春'],  eraLabel: '90年代' },
    { title: '傷痕',         artist: '林憶蓮', videoId: 'qG3DdU8S5fQ', soulTags: ['療癒','情歌'],  eraLabel: '90年代' },
  ...
  '2010s': [
    ...
    { title: '你就不要想起我', artist: '田馥甄', videoId: 'T8J7fkNp34k', soulTags: ['思念','深情'],  eraLabel: '10年代' },
    ...
    { title: '光年之外',     artist: '鄧紫棋', videoId: 'T4SimnaiktU', soulTags: ['情歌','磅礴'],  eraLabel: '10年代' },
