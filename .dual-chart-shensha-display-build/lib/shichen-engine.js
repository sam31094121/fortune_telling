...
exports.SHICHEN_LIST = void 0;
exports.getShichenInfo = getShichenInfo;
exports.shichenFromClockHour = shichenFromClockHour;
exports.julianDayNumber = julianDayNumber;
exports.getDayPillarIndex = getDayPillarIndex;
exports.getHourPillar = getHourPillar;
exports.getShichenPersonalityAdjust = getShichenPersonalityAdjust;
exports.computeShichenProfile = computeShichenProfile;
...
function getShichenInfo(branchIndex) {
    const i = ((branchIndex % 12) + 12) % 12;
    return exports.SHICHEN_LIST[i];
}
function shichenFromClockHour(hour24) {
...
function getDayPillarIndex(birthDate) {
...
const SHICHEN_PERSONALITY_ADJUST = {
...
function computeShichenProfile(input) {
    ...
    const shichen = isKnown ? getShichenInfo(input.shichenBranchIndex) : pickAuspiciousShichen(dayBranchIndex);
