...
if (!taijiSystem.includes('Level01SpatialLightning({ active, origin, variant, lowPower') || !taijiSystem.includes('group.rotation.set(0, 0, 0)') || taijiSystem.includes('origin={lightningOrigin} poseRef=')) throw new Error('the card-space lightning field must remain fixed while the Taiji rotates');
...
if (!audio.includes('const THUNDER_SOURCES') || !audio.includes("'/audio/taiji/lightning-strike.mp3'") || !audio.includes("'/audio/taiji/dry-thunder.mp3'") || !audio.includes("'/audio/taiji/loud-thunder.mp3'") || !audio.includes("'/audio/taiji/peals-of-thunder.mp3'") || !audio.includes("'/audio/taiji/earth-rift.mp3'") || !audio.includes("'/audio/taiji/tide-surge.flac'") || !audio.includes("'/audio/taiji/typhoon-wind.m4a'") || !audio.includes("'/audio/taiji/tornado-wind.m4a'") || !audio.includes('this.lightningVariantIndex += 1')) throw new Error('lightning must rotate through eight licensed real recordings while preserving the original four');
