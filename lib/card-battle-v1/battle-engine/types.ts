...
import type { BattleConfig, CardStats } from '../config/battle-config';
import type { PlayerElement } from '../element-engine/index';
import type { BeastBattleSlot } from '../beast-engine/index';
import type { BattleOutcome, RewardResult } from '../reward-engine/index';
import type { TransformForm } from '../transformation-engine/index';
