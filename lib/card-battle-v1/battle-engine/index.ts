...
import { isCounter } from '../element-engine/index';
import { tryInject } from '../injection-engine/index';
import { checkAndApplyTransform } from '../transformation-engine/index';
import { createEmptyBeastSlot } from '../beast-engine/index';
import { computeRewards } from '../reward-engine/index';
import {
  getCardDef,
  type TestCardDef,
