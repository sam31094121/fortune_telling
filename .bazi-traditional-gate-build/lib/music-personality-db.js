...
exports.PersonalityToMusicMapping = exports.VoiceCharacteristicMap = exports.GenderVoiceMap = exports.NameSemanticMap = exports.BloodTypeMap = exports.BirthdayPersonalityMap = exports.ZodiacPersonalityMap = exports.EraDatabase = void 0;
// ?葛隤??????冽??葛隤???????詨赯??塗??
...
// ?賹??剔捂赯菟????冽?31 ?剜???皜????
// ?鞊????垮謑?賹?殉????? ????對??舀０?????蹎?
exports.BirthdayPersonalityMap = {
...
// ??止??摮萄???冽????????荒?? ???剔捂赯菟?潸縣??
exports.VoiceCharacteristicMap = {
...
// ???瞉??鞎??謜冪?????塗?????
exports.PersonalityToMusicMapping = {
    emotion: {
